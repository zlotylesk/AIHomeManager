...
use App\Module\Tasks\Application\Handler\CompleteTaskHandler;
...
{
    public function testCompletesTaskAndDispatchesEvent(): void
    {
        ...
        $handler = new CompleteTaskHandler($repo, $eventBus, new NullLogger());
        $handler(new CompleteTask('t-1'));
    ...
    public function testThrowsWhenTaskNotFound(): void
    {
        ...
        $handler(new CompleteTask('missing'));
    }
}
