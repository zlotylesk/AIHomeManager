...
**Integracja — merge do developa (autonomiczny run).** Zadanie (Ścieżka A) i epic review merguje się do developa **samodzielnie** po zielonym CI — nie czekaj na review usera:
