...
```bash
INIT=$(node "C:/Users/poczt/PhpstormProjects/AIHM/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/poczt/PhpstormProjects/AIHM/.claude/get-shit-done/templates/spec.md.
