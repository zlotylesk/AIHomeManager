...
```
Agent(
  prompt="Read C:/Users/poczt/PhpstormProjects/AIHM/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/poczt/PhpstormProjects/AIHM/.claude/get-shit-done/templates/VALIDATION.md`
