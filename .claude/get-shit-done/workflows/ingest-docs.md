...
```bash
INIT=$(node "C:/Users/poczt/PhpstormProjects/AIHM/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/poczt/PhpstormProjects/AIHM/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
