...
**Wydania:** ostatni tag `1.5.0` (2026-05-17) zamykający epic **HMAI-124** Persistence & DB integrity (9/9 podzadań) + 7 mniejszych fixów z parent epików HMAI-131/HMAI-128 (HMAI-89, 91, 101, 108, 111, 117, 118). 421/421 PHP + 5/5 Playwright + 28 Newman requests. Pełny CHANGELOG: `CHANGELOG.md`. Poprzednie: 1.4.0 (HMAI-125 Test coverage, 2026-05-16), 1.3.0 (HMAI-127 + HMAI-130, 2026-05-16), 1.2.0 (HMAI-123 Critical findings, 2026-05-07).
