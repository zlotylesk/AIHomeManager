...
**Wydania:** ostatni tag `1.6.0` (2026-05-17) zamykający epic **HMAI-126** Operability & observability (6/6 podzadań: HMAI-133, 107, 112, 37, 39, 35). 451/451 PHP + 5/5 Playwright + 28 Newman requests. Pełny CHANGELOG: `CHANGELOG.md`. Poprzednie: 1.5.0 (HMAI-124 Persistence & DB integrity, 2026-05-17), 1.4.0 (HMAI-125 Test coverage, 2026-05-16), 1.3.0 (HMAI-127 + HMAI-130, 2026-05-16), 1.2.0 (HMAI-123 Critical findings, 2026-05-07).
