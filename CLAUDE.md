...
Single-user system automatyzacji codziennych czynności. Stack: PHP 8.5 + Symfony 8 + MySQL 8.4 LTS + Redis 8 + RabbitMQ 3.12. Heksagonalna architektura, CQRS z dwoma busami.
