...
**Status:** projekt operacyjny, ostatni tag `1.14.0` (Tasks — panel GUI zarządzania zadaniami: lista + CRUD + complete/cancel + filtr statusu + szczegóły + eksport CSV/PDF na torze Twig + vanilla JS; epic review dołożył mobilny E2E i responsywną tabelę). Sześć modułów domenowych w produkcji. Pełna historia → [CHANGELOG.md](CHANGELOG.md).
