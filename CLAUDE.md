...
**Wydania:** ostatni tag `1.7.1` (2026-05-19) — domknięcie epica **HMAI-128** Frontend hardening: druga partia (HMAI-41 Webpack Encore + Stimulus pilot dla Series UI + epic review z `apiCall` wpięciem w 4 modułach + CSP/Encore regression tests + Confluence id 52297730 v2 full rewrite). 453/453 PHP (+2 vs 1.7.0 — regression guards) + 5/5 Playwright + 28/28 Newman. Pełny CHANGELOG: `CHANGELOG.md`. Poprzednie: 1.7.0 (HMAI-128 batch 1, 2026-05-18), 1.6.0 (HMAI-126 Operability, 2026-05-17), 1.5.0 (HMAI-124 Persistence, 2026-05-17), 1.4.0 (HMAI-125 Test coverage, 2026-05-16), 1.3.0 (HMAI-127 + HMAI-130, 2026-05-16), 1.2.0 (HMAI-123 Critical findings, 2026-05-07).
