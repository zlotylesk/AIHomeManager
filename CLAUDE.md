...
**Status:** projekt operacyjny, ostatni tag `1.13.0` (Series MVP gap-closure: CRUD + watched + realny numer + metadane + lista z kolorowaniem + import z Trakt obejrzanych i ocen). Sześć modułów domenowych w produkcji. Pełna historia → [CHANGELOG.md](CHANGELOG.md).
